...
d.find_element_by_id('input-uname').send_keys('superadmin')  # 点击输入框，输入用户名
d.find_element_by_id('input-upwd').send_keys('Admin@123')  # 点击密码输入框，输入密码
d.find_element('xpath','//*[text()="登录"]').click()  # 点击登录
